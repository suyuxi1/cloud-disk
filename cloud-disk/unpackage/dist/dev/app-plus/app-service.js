...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _navBar = _interopRequireDefault(__webpack_require__(/*! ../../components/common/nav-bar.vue */ 15));\nvar _uniSearchBar = _interopRequireDefault(__webpack_require__(/*! ../../components/uni-search-bar/uni-search-bar.vue */ 25));\nvar _indexCard = _interopRequireDefault(__webpack_require__(/*! ../../components/index-card/index-card.vue */ 36));\nvar _fList = _interopRequireDefault(__webpack_require__(/*! ../../components/common/f-list.vue */ 41));\nvar _fDialog = _interopRequireDefault(__webpack_require__(/*! ../../components/common/f-dialog.vue */ 46));\nvar _uniPopup = _interopRequireDefault(__webpack_require__(/*! ../../components/uni-ui/uni-popup/uni-popup.vue */ 51));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default =\n{\n  components: {\n    navBar: _navBar.default,\n    uniSearchBar: _uniSearchBar.default,\n    indexCard: _indexCard.default,\n    fList: _fList.default,\n    fDialog: _fDialog.default,\n    uniPopup: _uniPopup.default },\n\n  data: function data() {\n    return {\n      renameValue: '',\n      newdirname: '',\n      list: [],\n      addList: [\n      {\n        icon: 'icon-file-b-6',\n        color: 'text-success',\n        name: '上传图片' },\n\n      {\n        icon: 'icon-file-b-9',\n        color: 'text-primary',\n        name: '上传视频' },\n\n      {\n        icon: 'icon-file-b-8',\n        color: 'text-muted',\n        name: '上传文件' },\n\n      {\n        icon: 'icon-file-b-2',\n        color: 'text-warning',\n        name: '新建文件夹' }],\n\n\n      dirs: [], //这里的dirs是记录路由的，sortOptions数组记录排序方式，其中的key可以作为查询参数传到后台，\n      sortIndex: 0,\n      sortOptions: [\n      {\n        name: '按名称排列',\n        key: 'name' },\n\n      {\n        name: '按时间排序',\n        key: 'created_time' }] };\n\n\n\n  },\n  onLoad: function onLoad() {\n    // uni.request({\n    // \turl: 'http://127.0.0.1:7001/list',\n    // \tmethod: 'GET',\n    // \tsuccess: res => {\n    // \t\tconsole.log(res.data);\n    // \t}\n    // });\n\n    //页面加载的时候，从本地存储读取dirs，如果不清空，会从上次离开的地方继续\n    var dirs = uni.getStorageSync('dirs');\n    if (dirs) {\n      this.dirs = JSON.parse(dirs);\n    }\n    this.getData();\n  },\n  methods: {\n    //生成唯一ID\n    genID: function genID(length) {\n      return Number(\n      Math.random().\n      toString().\n      substr(3, length) + Date.now()).\n      toString(36);\n    },\n    //上传\n    upload: function upload(file, type) {var _this = this;\n      //上传文件类型\n      var t = type;\n      //上传的key，用来区分每个文件\n      var key = this.genID(8);\n      //构建上传文件的对象，文件名，类型，大小，唯一的key，进度，状态，创建时间\n      var obj = {\n        name: file.name,\n        type: t,\n        size: file.size,\n        key: key,\n        progress: 0,\n        status: true,\n        create_time: new Date().getTime() };\n\n      //创建上传任务，分发给Vuex的Actions，异步上传调度，主要是实现上传进度的回调\n      this.$store.dispatch('createUploadJob', obj);\n      //上传，查询参数为当前位置所在目录的id，body参数为文件路径\n      this.$H.\n      upload(\n      '/upload?file_id=' + this.file_id,\n      {\n        filePath: file.path },\n\n      function (p) {\n        //更新上传任务进度\n        _this.$store.dispatch('updateUploadJob', {\n          status: true,\n          progress: p,\n          key: key });\n\n      }).\n\n      then(function (res) {\n        //上传成功，请求数据更新列表\n        _this.getData();\n      });\n    },\n\n    //搜索功能，关键字为空就请求所有数据的接口，否则就将文本框实时输入的内容进行搜索\n    search: function search(e) {var _this2 = this;\n      if (e.detail.value == '') {\n        return this.getData();\n      }\n      this.$H.\n      get('/file/search?keyword=' + e.detail.value, {\n        token: true }).\n\n      then(function (res) {\n        _this2.list = _this2.formatList(res.rows);\n      });\n    },\n    //将数据格式化为我们需要显示的样子，不同的文件类型，是否选中\n    formatList: function formatList(list) {\n      return list.map(function (item) {\n        var type = 'none';\n        if (item.isdir === 1) {\n          type = 'dir';\n        } else {\n          type = item.ext.split('/')[0] || 'none';\n        }\n        return _objectSpread({\n          type: type,\n          checked: false },\n        item);\n\n      });\n    },\n    getData: function getData() {var _this3 = this;\n      //每次请求API接口的时候，把最新的file_id和选取的orderby排序方式带上\n      __f__(\"log\", this.file_id + '>>>>>>>>>>>>>>>>>', \" at pages/index/index.vue:270\");\n      var orderby = this.sortOptions[this.sortIndex].key;\n      __f__(\"log\", orderby + ',<<<<<<<<<<<<<<<<<<', \" at pages/index/index.vue:272\");\n      this.$H.\n      get(\"/file?file_id=\".concat(this.file_id, \"&orderby=\").concat(orderby), {\n        token: true }).\n\n      then(function (res) {\n        __f__(\"log\", res, \" at pages/index/index.vue:278\");\n        _this3.list = _this3.formatList(res.rows);\n      });\n    },\n    select: function select(e) {\n      this.list[e.index].checked = e.value;\n    },\n    //全选/取消全选\n    handleCheckAll: function handleCheckAll(checked) {\n      this.list.forEach(function (item) {\n        item.checked = checked;\n      });\n    },\n    //处理底部操作条事件，这里仅对删除做了处理\n    handleBottomEvent: function handleBottomEvent(item) {var _this4 = this;\n      switch (item.name) {\n        case '删除':\n          this.$refs.delete.open(function (close) {\n            //加载框过渡\n            uni.showLoading({\n              title: '删除中...',\n              mask: false });\n\n            //删除接口需要传\"1,2,3\"这样，用map取出checkList中每条数据的id，然后用join拼接上逗号\n            var ids = _this4.checkList.map(function (item) {return item.id;}).join(',');\n            _this4.$H.\n            post(\n            '/file/delete',\n            {\n              ids: ids },\n\n            { token: true }).\n\n            then(function (res) {\n              //重新请求下数据\n              _this4.getData();\n              uni.showToast({\n                title: '删除成功',\n                icon: 'none' });\n\n              //结束loading\n              uni.hideLoading();\n            }).\n            catch(function (err) {\n              uni.hideLoading();\n            });\n            close();\n          });\n          // this.$refs.dialog.open(close => {\n          // \t//对list进行过滤，留下未被选中的\n          // \tthis.list = this.list.filter(item => !item.checked);\n          // \tclose();\n          // \tuni.showToast({\n          // \t\ttitle: '删除成功',\n          // \t\ticon: 'none'\n          // \t});\n          // \t//在这里可以写点击删除需要做的回调事件，这里先在控制台模拟，实际需要把checkList移除掉\n          // \t// console.log('删除文件');\n          // \t// console.log(this.checkList);\n          // });\n          break;\n        case '重命名':\n          // 重命名只能对单个文件进行,所以this.checkList[0],也就是选中的唯一元素\n          this.renameValue = this.checkList[0].name;\n          this.$refs.rename.open(function (close) {\n            if (_this4.renameValue == '') {\n              return uni.showToast({\n                title: '文件名称不能为空',\n                icon: 'none' });\n\n            }\n            // //更新改元素name值，实时看到效果\n            // this.checkList[0].name = this.renameValue;\n            //重命名接口需要三个参数，自身id，目录id，新名称\n            __f__(\"log\", _this4.checkList[0].id + '>>>>>>>' + _this4.file_id, \" at pages/index/index.vue:352\");\n            _this4.$H.\n            post(\n            '/file/rename',\n            {\n              id: _this4.checkList[0].id,\n              file_id: _this4.file_id,\n              name: _this4.renameValue },\n\n            { token: true }).\n\n            then(function (res) {\n              _this4.checkList[0].name = _this4.renameValue;\n              uni.showToast({\n                title: '重命名成功',\n                icon: 'none' });\n\n            });\n            close();\n          });\n          break;\n        case '下载':\n          this.download();\n          break;\n        case '分享':\n          //增加“分享”点击事件，调用share方法去请求接口生成一个分享链接，\n          //然后把全选置为false，目的是让下面的操作条隐藏（没有文件被选中，底部操作条是不会弹出的）\n          this.share();\n          this.handleCheckAll(false);\n          break;\n        default:\n          break;}\n\n    },\n    share: function share() {\n      this.$H.\n      post(\n      '/share/create',\n      {\n        file_id: this.checkList[0].id },\n\n      { token: true }).\n\n      then(function (res) {\n        uni.showModal({\n          content: res,\n          showCancel: false,\n          success: function success(result) {\n            //不能再用res，会和前面冲突\n\n            uni.setClipboardData({\n              //复制到剪贴板\n              data: res,\n              success: function success() {\n                uni.showToast({\n                  title: '复制成功',\n                  icon: 'none' });\n\n              } });\n\n\n          } });\n\n      });\n    },\n    //下载\n    download: function download() {var _this5 = this;\n      this.checkList.forEach(function (item) {\n        if (item.isdir === 0) {\n          var key = _this5.genID(8);\n\n          var obj = {\n            name: item.name,\n            type: item.type,\n            size: item.size,\n            key: key,\n            progress: 0,\n            status: true,\n            created_time: new Date().getTime() };\n\n          //创建下载任务\n          _this5.$store.dispatch('createDownloadJob', obj);\n          var url = item.url;\n          var d = uni.downloadFile({\n            url: url,\n            success: function success(res) {\n              if (res.statusCode === 200) {\n                __f__(\"log\", '下载成功', res, \" at pages/index/index.vue:439\");\n\n                uni.saveFile({\n                  tempFilePath: item.tempFilePath });\n\n\n              }\n            } });\n\n          d.onProgressUpdate(function (res) {\n            _this5.$store.dispatch('updateDownLoadJob', {\n              progress: res.progress,\n              status: true,\n              key: key });\n\n          });\n        }\n      });\n      uni.showToast({\n        title: '已加入下载任务',\n        icon: 'none' });\n\n      this.handleCheckAll(false);\n    },\n\n    //打开添加操作条\n    openAddDialog: function openAddDialog() {\n      this.$refs.add.open();\n    },\n\n    //处理添加操作条的各种事件\n    handleAddEvent: function handleAddEvent(item) {var _this6 = this;\n      this.$refs.add.close();\n      switch (item.name) {\n        case '新建文件夹':\n          this.$refs.newdir.open(function (close) {\n            if (_this6.newdirname == '') {\n              return uni.showToast({\n                title: '文件夹名称不能为空',\n                icon: 'name' });\n\n            }\n            //请求新增文件夹接口\n            _this6.$H.\n            post(\n            '/file/createdir',\n            {\n              file_id: _this6.file_id,\n              name: _this6.newdirname },\n\n            { token: true }).\n\n            then(function (res) {\n              _this6.getData();\n              uni.showToast({\n                title: '新建文件夹成功',\n                icon: 'none' });\n\n            });\n            // //模拟请求服务器，这里先添加到list数组中\n            // this.list.push({\n            // \ttype: 'dir',\n            // \tname: this.newdirname,\n            // \tcreate_time: '2020-10-22 17:00'\n            // });\n            // uni.showToast({\n            // \ttitle: '新建文件夹成功',\n            // \ticon: 'name'\n            // });\n            close();\n            _this6.newdirname = '';\n          });\n          break;\n        case '上传图片':\n          //选择图片，，限制为9张\n          uni.chooseImage({\n            count: 9,\n            success: function success(res) {\n              //选择图片成功，就循环异步调用上传接口\n              res.tempFiles.forEach(function (item) {\n                _this6.upload(item, 'image');\n              });\n            } });\n\n          break;\n        default:\n          break;}\n\n    },\n\n    // 列表点击事件处理\n    doEvent: function doEvent(item) {\n      __f__(\"log\", item, \" at pages/index/index.vue:531\");\n      //对文件类型进行各种情况处理\n      switch (item.type) {\n        //预览图片\n        case 'image':\n          var images = this.list.filter(function (item) {\n            return item.type === 'image';\n          });\n          uni.previewImage({\n            current: item.url,\n            urls: images.map(function (item) {return item.url;}) });\n\n          break;\n        //视频播放\n        case 'video':\n          __f__(\"log\", '进入视频', \" at pages/index/index.vue:546\");\n          uni.navigateTo({\n            url: '../video/video?url=' + item.url + '&title=' + item.name });\n\n          break;\n        default:\n          //把当前元素push到路由数组中去，然后用这个目录的id，去请求它的层级里的数据，同时存到本地存储中\n          this.dirs.push({\n            id: item.id,\n            name: item.name });\n\n          this.getData();\n          uni.setStorage({\n            key: 'dirs',\n            data: JSON.stringify(this.dirs) });\n\n          break;}\n\n    },\n    //切换排序\n    changSort: function changSort(index) {\n      // this.sortIndex = index;\n      // this.$refs.sort.close();\n      this.sortIndex = index;\n      this.getData();\n      this.$refs.sort.close();\n    },\n    openSortDialog: function openSortDialog() {\n      this.$refs.sort.open();\n    },\n    // 返回上一个目录\n    //顶部导航栏在子目录的时候，会有返回箭头，它的事件如下，路由出栈，再获取回到上一层的最新数据，存储\n    backUp: function backUp() {\n      this.dirs.pop();\n      this.getData();\n      uni.setStorage({\n        key: 'dirs',\n        data: JSON.stringify(this.dirs) });\n\n    } },\n\n\n  computed: {\n    //两个计算属性，实时根据当前dirs数组的变化，\n    //file_id计算属性取得应该传到后端的file_id参数（就是当前目录），\n    //current计算属性则用来切换导航栏样式\n    file_id: function file_id() {\n      var l = this.dirs.length;\n      if (l == 0) {\n        return 0;\n      }\n      return this.dirs[l - 1].id;\n    },\n    current: function current() {\n      var l = this.dirs.length;\n      if (l === 0) {\n        return false;\n      }\n      return this.dirs[l - 1];\n    },\n    //选中列表\n    checkList: function checkList() {\n      return this.list.filter(function (item) {return item.checked;});\n    },\n    checkCount: function checkCount() {\n      return this.checkList.length;\n    },\n    actions: function actions() {\n      if (this.checkCount > 1) {\n        return [\n        {\n          icon: 'icon-xiazai',\n          name: '下载' },\n\n        {\n          icon: 'icon-shanchu',\n          name: '删除' }];\n\n\n      }\n      return [\n      {\n        icon: 'icon-xiazai',\n        name: '下载' },\n\n      {\n        icon: 'icon-fenxiang-1',\n        name: '分享' },\n\n      {\n        icon: 'icon-shanchu',\n        name: '删除' },\n\n      {\n        icon: 'icon-chongmingming',\n        name: '重命名' }];\n\n\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 14)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///13\n");
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _vuex = __webpack_require__(/*! vuex */ 73);function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default =\n{\n  data: function data() {\n    return {};\n  },\n  onLoad: function onLoad() {\n    __f__(\"log\", this.$store.state.user, \" at pages/my/my.vue:39\");\n  },\n  computed: _objectSpread(_objectSpread({},\n\n  (0, _vuex.mapState)({\n    user: function user(state) {return state.user;} })), {}, {\n\n    //progress计算属性用来实时显示用户的空间使用率\n    progress: function progress() {\n      if (this.user.total_size === 0) {\n        return 0;\n      }\n      return this.user.used_size / this.user.total_size * 100;\n    } }),\n\n  onShow: function onShow() {\n    //每次进入页面，都要获取用户的空间大小\n    this.getSize();\n  },\n  methods: {\n    //请求接口，获取最新的空间大小，并且交给Vuex更新\n    getSize: function getSize() {var _this = this;\n      this.$H.get('getsize', { token: true }).then(function (res) {\n        _this.$store.dispatch('updateSize', res);\n      });\n    },\n    logout: function logout() {\n      //调用Vuex的logout，不需要直接在这里调用接口，在Vuex里异步调用即可\n      this.$store.dispatch('logout').then(function (res) {\n        uni.showToast({\n          title: '退出成功',\n          icon: 'none' });\n\n      });\n    } },\n\n  filters: {\n    bytesToSize: function bytesToSize(bytes) {\n      if (bytes === 0) return '0 KB';\n      var k = 1000,\n      sizes = ['KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB'],\n      i = Math.floor(Math.log(bytes) / Math.log(k));\n      return (bytes / Math.pow(k, i)).toPrecision(3) + ' ' + sizes[i];\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 14)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///72\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 90));\nvar _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 73));\n\n\nvar _request = _interopRequireDefault(__webpack_require__(/*! ../common/request.js */ 94));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}_vue.default.use(_vuex.default);var _default =\n\nnew _vuex.default.Store({\n  state: {\n    uploadList: [],\n    downlist: [],\n    user: null,\n    token: null },\n\n  actions: {\n    //首先读取到剪切板的内容\n    //从之前的剪贴板中解析出key的值，就是share表中的sharedUrl，真正的链接地址和它有关\n    getShareUrl: function getShareUrl(_ref)\n\n    {var state = _ref.state;\n      //#ifdef H5\n      uni.getClipboardData({\n        success: function success(res) {\n          //通过前面结果可以看到剪贴的链接是以http://127.0.0.1:7001/开头的，接口上线了这个地址要改\n          if (res.data.includes('http://127.0.0.1:7001/')) {\n            //需要从完整的链接截取出key的值，数据库应该知道真正的链接就是和这个有关的\n            var key = res.data.substring(res.data.lastIndexOf('\\/') + 1, res.data.length);\n            if (!key) {\n              return;\n            }\n            uni.showModal({\n              content: '检测到有分享内容，是否打开？',\n              success: function success(res) {\n                if (res.confirm) {\n                  uni.navigateTo({\n                    url: \"/pages/shareurl/shareurl?key=\" + key });\n\n                  //清空剪切板\n                  uni.setClipboardData({\n                    data: '' });\n\n                }\n              } });\n\n          }\n        } });\n\n    },\n    // //清除传输记录\n    clearList: function clearList(_ref2)\n\n    {var state = _ref2.state;\n      if (state.user) {\n        state.downlist = [];\n        state.uploadList = [];\n        uni.removeStorageSync(\"downlist_\" + state.user.id);\n        uni.removeStorageSync(\"uploadList_\" + state.user.id);\n      }\n    },\n\n    // 创建一个下载任务\n    createDownloadJob: function createDownloadJob(_ref3,\n\n    obj) {var state = _ref3.state;\n      state.downlist.unshift(obj);\n      uni.setStorage({\n        key: \"downlist_\" + state.user.id,\n        data: JSON.stringify(state.downlist) });\n\n    },\n    //更新下载任务进度\n    updateDownLoadJob: function updateDownLoadJob(_ref4,\n\n    obj) {var state = _ref4.state;\n      var i = state.downlist.findIndex(function (item) {return item.key === obj.key;});\n      if (i !== -1) {\n        state.downlist[i].progress = obj.progress;\n        state.downlist[i].status = obj.status;\n        uni.setStorage({\n          key: \"downlist_\" + state.user.id,\n          data: JSON.stringify(state.downlist) });\n\n      }\n    },\n\n    //创建一个上传任务\n    createUploadJob: function createUploadJob(_ref5,\n\n    obj) {var state = _ref5.state;\n      //添加到上传队列的最前面\n      state.uploadList.unshift(obj);\n      //异步设置本地存储，记录键值对为：上传人和上传内容\n      uni.setStorage({\n        key: \"uploadList_\" + state.user.id,\n        data: JSON.stringify(state.uploadList) });\n\n    },\n    //更新上传任务进度\n    updateUploadJob: function updateUploadJob(_ref6,\n\n    obj) {var state = _ref6.state;\n      //在上传队列中查找用户的上传任务\n      var i = state.uploadList.findIndex(function (item) {return item.key === obj.key;});\n      //如果存在\n      if (i !== -1) {\n        //更新progress属性的值和上传状态的值\n        state.uploadList[i].progress = obj.progress;\n        state.uploadList[i].status = obj.status;\n        //异步更新本地存储\n        uni.setStorage({\n          key: \"uploadList_\" + state.user.id,\n          data: JSON.stringify(state.uploadList) });\n\n      }\n    },\n    //退出登录\n    logout: function logout(_ref7)\n\n    {var state = _ref7.state;\n      _request.default.post('/logout', {}, {\n        token: true });\n\n      state.user = null;\n      state.token = null;\n      uni.removeStorageSync('user');\n      uni.removeStorageSync('token');\n      uni.removeStorageSync('dirs');\n      //重启应用\n      uni.reLaunch({\n        url: '/pages/login/login' });\n\n    },\n    login: function login(_ref8,\n\n    user) {var state = _ref8.state;\n      state.user = user;\n      state.token = user.token;\n\n      uni.setStorageSync('user', JSON.stringify(user));\n      uni.setStorageSync('token', user.token);\n    },\n    initUser: function initUser(_ref9)\n\n    {var state = _ref9.state;\n      var user = uni.getStorageSync('user');\n      if (user) {\n        state.user = JSON.parse(user);\n        state.token = state.user.token;\n      }\n    },\n    updateSize: function updateSize(_ref10,\n\n    e) {var state = _ref10.state;\n      state.user.total_size = e.total_size;\n      state.user.used_size = e.used_size;\n    } } });exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///95\n");
